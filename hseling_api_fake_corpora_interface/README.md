# Fake Corpora Interface

Fake Corpora Interface description
...
## Development environment and release process
 ...
 - create virtualenv with Flask and Fake Corpora Interface installed into it (latter is installed in
...
install it (`pip install hseling_api_fake_corpora_interface.tar.gz`), ensure that configuration file exists and
`HSELING_API_FAKE_CORPORA_INTERFACE_SETTINGS` environment variable points to it, ensure that user has access to the
